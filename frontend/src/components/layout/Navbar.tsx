      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <nav className="flex items-center gap-4">
            ...
            {/* මෙන්න මෙතැනට අලුතින් Create Package ලින්ක් එක ADMIN සහ GUIDE ට විතරක් පේන්න දැම්මා */}
            <RoleGate allowed={['ADMIN', 'GUIDE']}>
              <Link to="/packages/new" className="text-sm font-medium text-slate-700 hover:text-blue-600">
                Create Package
              </Link>
            </RoleGate>
